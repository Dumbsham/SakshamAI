      ...
      <div className="bg-white/70 dark:bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-black/5 dark:border-white/10 shadow-xl">
        ...
        <div className="flex flex-col items-center">
          <button
            ...
            className="relative w-24 h-24 rounded-full bg-gradient-to-r from-orange-500 to-pink-600 shadow-2xl hover:scale-110 transition-transform animate-float"
          >
            {recordingState === 'recording' ? (
              <>
                <MicOff className="w-10 h-10 text-white mx-auto" />
                <div className="absolute inset-0 rounded-full bg-red-500/30 animate-pulseRing"></div>
                <div className="absolute inset-0 rounded-full bg-red-500/30 animate-pulseRing animation-delay-500"></div>
              </>
            ) : (
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <span className="inline-block px-2 py-1 rounded text-xs font-medium bg-purple-500/10 text-purple-600 dark:text-purple-400">
                    {course.level}
                  </span>
                </div>
